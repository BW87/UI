...
class AnnouncementActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        announcementItemList.add(Announcement_Item("2021.04.28", "RBG 어플 다운로드 1000만 돌파 기념 선물 증정 이벤트!!"))
        announcementItemList.add(Announcement_Item("2021.04.27", "RBG APP 리뉴얼 안내"))
        announcementItemList.add(Announcement_Item("2021.04.26", "RBG 어플 다운로드 100만 돌파!"))
        announcementItemList.add(Announcement_Item("2021.04.25", "RBG APP 리뉴얼 중"))
        announcementItemList.add(Announcement_Item("2021.04.24", "RBG 어플 다운로드 10만 돌파"))
        announcementItemList.add(Announcement_Item("2021.03.23", "RBG 어플 업데이트 안내"))
        announcementItemList.add(Announcement_Item("2021.03.01", "3.1절 고객세터 휴무 안내"))
